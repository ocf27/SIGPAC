        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center"
            ...
            <div class="d-flex flex-column flex-center p-6 p-lg-10 w-100">
                ...
                <a href="index.html" class="mb-0 mb-lg-20">
                    <img alt="Logo" src="assets/media/logos/logoTec.png" class="h-40px h-lg-50px"/>
                </a>
                <!--end::Logo-->
                <!--begin::Image-->
                <img class="d-none d-lg-block mx-auto w-300px w-lg-75 w-xl-500px mb-10 mb-lg-20"
                     src="assets/media/misc/control-de-acceso.png" alt=""/>
                <!--end::Image-->
                <!--begin::Title-->
                <h1 class="d-none d-lg-block text-white fs-2qx fw-bold text-center mb-7">SIGPAC</h1>
                <!--end::Title-->
                <!--begin::Text-->
                <div class="d-none d-lg-block text-white fs-base text-center">Grandes
                    <a href="#" class="opacity-75-hover text-warning fw-semibold me-1">Emprededores,</a>
                    Líderes de <a href="#" class="opacity-75-hover text-warning fw-semibold me-1">Éxito</a>
        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
                ...
                <div class="w-lg-500px p-10">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                        ...
                        <div class="text-center mb-11">
                            ...
                            <!--end::Title-->
                            <!--begin::Subtitle-->
                            <div class="text-gray-500 fw-semibold fs-6">Ingresa tus credenciales</div>
                            <!--end::Subtitle=-->
                        </div>
                        <!--begin::Heading-->
                        <!--begin::Input group=-->
                        <div class="fv-row mb-8">
                            <!--begin::Username-->
                            <input type="text" placeholder="Escribe tu usuario" name="username" id="username"
                                   autocomplete="off"
            ...
            <div class="d-flex flex-center flex-wrap px-5">
                ...
                <div class="d-flex fw-semibold text-primary fs-base">
                    {{--                    <a href="https://keenthemes.com" class="px-5" target="_blank" disabled="true">Terms</a>--}}
                    {{--                    <a href="https://devs.keenthemes.com" class="px-5" target="_blank" disabled="true">Plans</a>--}}
                    {{--                    <a href="https://themes.getbootstrap.com/product/keen-the-ultimate-bootstrap-admin-theme/"--}}
                    {{--                       class="px-5" target="_blank" disabled="true">Contact Us</a>--}}
                </div>
                <!--end::Links-->
            </div>
            <!--end::Footer-->
